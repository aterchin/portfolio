...
<Aside variant="info" title="Stack">
  Scaffolded with Laravel Breeze + React using the **Inertia.js** starter kit. Inertia handles the bridge between Laravel's server-side routing and the React front-end &ndash; Laravel renders React components directly. ApexCharts for visualization, Sprout Social API as the data source.
</Aside>
